...
<form method="get" action="https://mca-official.live/member/update_password" role="form" class="forms-sample">

<div class="card mb-4 py-3 border-left-primary">
<div class="card-body">
     <p></p>
<input type="text" class="custom-select" placeholder="Username" name="username" value="Doney" readonly  >
<p></p>
<input type="text" class="custom-select" placeholder="old" name="old"  >
<p></p>

<input type="text" class="custom-select" placeholder="new" name="new" required="">
<p></p>
